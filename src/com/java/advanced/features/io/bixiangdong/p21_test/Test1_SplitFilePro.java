 ...
 * @since 2021/8/3
 */
public class Test1_SplitFilePro {
    static int i = 0;
...
//        File file = new File("H:\\xinjing.mp4");
        ...
        splitFile(dir, file);
        writeConfig(dir, file.getName(), i);
    }

    private static void writeConfig(File dir, String fileName, int i) throws IOException {
        Properties properties = new Properties();
        properties.setProperty("filename", fileName);
        properties.setProperty("partcount", String.valueOf(i));

        FileOutputStream fos = new FileOutputStream(new File(dir, i + ".properties"));
        properties.store(fos, "file name and part info");
        fos.close();
    }

    private static void splitFile(File dir, File file) throws IOException {
        // 每份5M
